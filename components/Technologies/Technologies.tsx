	...
	return (
		<div>
			...
			<h4 className='text-md mb-2 text-base font-normal text-gray-500 dark:text-gray-400'>
				Throughout my career, I used a lot of different technologies and
				I love to learn new ones in my free time.
			</h4>
			<h4 className='text-md mb-3 text-base font-normal text-gray-500 dark:text-gray-400'>
				Current stack:
			</h4>
			<div className='grid grid-cols-3 md:grid-cols-4 gap-6 mb-10'>
				...
				<SiSymfony className='text-4xl mr-2' />
			...
			<h4 className='text-md mb-4 text-base font-normal text-gray-500 dark:text-gray-400'>
